...
<asp:Content ID="Content1" ContentPlaceHolderID="contectPage" runat="server">
    ...
    <div class="slide v3">
        <div class="single-item js-banner">
            <div class="slide-img">
                <img src="/Areas/Client/statics/img/slider/image-slider6.jpg" alt="images" class="img-reponsive">
                    ...
                    <div class="col-md-7 col-sm-12">
                        <div class="product-item ver4 top-inner">
                            <div class="prod-item-img">
                                <a href="#">
                                    <img src="/Areas/Client/statics/img/products/iwatch2.jpg" alt="images" class="img-reponsive"></a>
                                <div class="prod-choose">
                                    ...
                                    <div class="prod-price">
                                        ...
                                        <span class="productPriceDiscount">Save<br>
                                            <span class="strong">$75.5</span></span>
                                    </div>
                                </div>
                            </div>
                            <div class="prod-info">
                    ...
                    <div class="col-md-5 col-sm-12 ">
                        <div class="product-item ver1 padding--bottom margin-r">
                            <div class="prod-item-img set--width">
                                <a class="image" href="#">
                                    <img src="/Areas/Client/statics/img/products/ipad.jpg" alt="images" class="img-responsive"></a>
                            </div>
                        ...
                        <div class="product-item ver1 margin-r ">
                            <div class="prod-item-img set--width">
                                <a class="image" href="#">
                                    <img src="/Areas/Client/statics/img/products/seiko.jpg" alt="images" class="img-responsive"></a>
                            </div>
                            <div class="prod-info ver1">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-15 col-sm-4 col-xs-6">
                                <div class="product-item ver2">
                                    <div class="prod-item-img bd-style-2">
                                        <a href="#">
                                            <img src="/Areas/Client/statics/img/products/sound3.jpg" alt="images" class="img-responsive"></a>
                                        <div class="button">
                                            <a href="#" class="addcart">ADD TO CART</a>
                                            <a href="#" class="view"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                        </div>
                            ...
                            <div class="col-md-15 col-sm-4 col-xs-6">
                                <div class="product-item ver2">
                                    <div class="prod-item-img bd-style-2">
                                        <a href="#">
                                            <img src="/Areas/Client/statics/img/products/tivi.jpg" alt="images" class="img-responsive"></a>
                                        <div class="button">
                                            <a href="#" class="addcart">ADD TO CART</a>
                                            <a href="#" class="view"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                        </div>
                            ...
                            <div class="col-md-15 col-sm-4 col-xs-6">
                                <div class="product-item ver2">
                                    <div class="prod-item-img bd-style-2">
                                        <a href="#">
                                            <img src="/Areas/Client/statics/img/products/sony.jpg" alt="images" class="img-responsive"></a>
                                        <div class="button">
                                            <a href="#" class="addcart">ADD TO CART</a>
                                            <a href="#" class="view"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                        </div>
                            ...
                            <div class="col-md-15 col-sm-4 col-xs-6">
                                <div class="product-item ver2">
                                    <div class="prod-item-img bd-style-2">
                                        <a href="#">
                                            <img src="/Areas/Client/statics/img/products/macbook.jpg" alt="images" class="img-responsive"></a>
                                        <div class="button">
                                            <a href="#" class="addcart">ADD TO CART</a>
                                            <a href="#" class="view"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                        </div>
