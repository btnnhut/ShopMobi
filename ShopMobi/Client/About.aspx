<%@ Page Title="" Language="C#" MasterPageFile="~/ShopMobi/Client/Default.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="ShopMobi.ShopMobi.Client.About" %>

<asp:Content ID="Content1" ContentPlaceHolderID="contectPage" runat="server">
    <section class="about-us-page">
        <div class="container">
            <div class="heading-sub ver2">
                <h3 class="pull-left">Giới thiệu Shop BTN</h3>
                <ul class="other-link-sub pull-right">
                    <li><a href="Home.aspx">Home</a></li>
                    <li><a class="active" href="#aboutus">Giới thiệu</a></li>
                </ul>
                <div class="clearfix"></div>
            </div>
            <div class="widget-about-us">
                <a href="#">
                    <img src="/Areas/Client/statics/img/about/about-us3.jpg" alt="imgages" class="img-responsive"></a>
